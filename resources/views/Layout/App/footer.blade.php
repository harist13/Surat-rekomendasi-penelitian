        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="hover:text-blue-200 transition">Tentang Kami</a></li>
                        <li><a href="#" class="hover:text-blue-200 transition">Kebijakan Privasi</a></li>
                        <li><a href="#" class="hover:text-blue-200 transition">Syarat & Ketentuan</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="hover:text-blue-200 transition">Permohonan Izin</a></li>
                        <li><a href="#" class="hover:text-blue-200 transition">Status Pengajuan</a></li>
                        <li><a href="#" class="hover:text-blue-200 transition">Download Formulir</a></li>
                    </ul>
                </div>
