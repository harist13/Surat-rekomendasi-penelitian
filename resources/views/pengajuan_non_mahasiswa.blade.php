                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="jabatan" class="w-full p-2 border rounded-md" required>
                                </div>
                                <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="bidang" class="w-full p-2 border rounded-md" required>
                                </div>
                            </div>
                        </div>
            ...
            <div class="lg:w-1/3">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <button class="w-full bg-[#004aad] text-white py-2 rounded-md hover:bg-[#003b8a] transition flex items-center justify-center gap-2">
