        ...
        <div class="p-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                     ...
                     <div class="flex items-center space-x-2">
                        <form id="main-filter-form" action="{{ route('datapengajuannonmahasiswa') }}" method="GET" class="flex items-center space-x-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="search" id="main-search-input" class="block w-60 p-2.5 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari Non-Mahasiswa" value="{{ request('search') }}">
                            ...
                            @foreach ($nonMahasiswas as $index => $nonMahasiswa)
                                <tr class="bg-white hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 border border-gray-200">
                                       <button type="button" 
                                                onclick="openAnggotaModal({{ json_encode($nonMahasiswa->anggota_peneliti) }})" 
                ...
                <div class="mt-12 mb-8">
                    ...
                    @if($ditolakNonMahasiswas->count() > 0)
                    <div class="flex justify-between items-center mt-6">
                        <div class="text-sm text-gray-600">
                            Menampilkan {{ $ditolakNonMahasiswas->firstItem() ?? 0 }} sampai {{ $ditolakNonMahasiswas->lastItem() ?? 0 }} dari {{ $ditolakNonMahasiswas->total() }} Total Data
                        </div>
                        <div class="flex">
