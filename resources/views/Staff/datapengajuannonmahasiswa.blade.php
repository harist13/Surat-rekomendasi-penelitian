                                        ...
                                        <td class="px-4 py-3 border border-gray-200">
                                            <div class="flex space-x-2 justify-center">
                                                ...
                                                <button type="button" class="text-blue-500 hover:text-blue-700 p-1" 
                                                    onclick="openNotificationModal('{{ $nonMahasiswa->id }}', '{{ $nonMahasiswa->nama_lengkap }}', '{{ $nonMahasiswa->no_hp }}', '{{ $nonMahasiswa->judul_penelitian }}', '{{ $notifikasi ? $notifikasi->alasan_penolakan : 'Tidak ada alasan yang dicatat' }}')" 
