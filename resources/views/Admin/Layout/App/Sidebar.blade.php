            ...
            <nav>
                <ul class="space-y-2">
                    ...
                    <ul class="hidden group-hover:block ml-4 pl-2 space-y-2">
                        <li>
                            <a href="{{ route('admin.datasurvei') }}" class="flex items-center p-3 text-gray-700 hover:bg-blue-50 rounded-lg transition">
                                <span class="ml-6">kuisioner</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.dataresponden') }}" class="flex items-center p-3 text-gray-700 hover:bg-blue-50 rounded-lg transition">
                                <span class="ml-6">responden</span>
                            </a>
                        </li>
                    </ul>
                </li>
