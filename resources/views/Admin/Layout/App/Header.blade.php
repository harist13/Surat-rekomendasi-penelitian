    ...
    <div id="profileModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-lg shadow-xl w-80 overflow-hidden">
            ...
            <div class="p-4">
                <!-- Profile Options -->
                <div class="space-y-2">
                    <a href="#" id="editProfileBtn" class="flex items-center p-2 hover:bg-gray-100 rounded-lg transition">
...
<div id="notifmodal" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center hidden">
    <div class="bg-white rounded-lg shadow-xl w-[600px] max-w-full max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div class="bg-[#A7CDFF] px-6 py-4 flex justify-between items-center">
            <h1 class="text-xl font-bold text-gray-900">Notifikasi Data Surat</h1>
            <button id="markAllAsRead" class="text-blue-700 text-sm font-medium hover:underline">Tandai Baca Semua</button>
        </div>

        <!-- Konten Notifikasi -->
        <div class="p-4 space-y-4 overflow-y-auto max-h-[400px]" id="notificationContent">
            <!-- Data Surat Notifications -->
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (markAllAsRead) {
        markAllAsRead.addEventListener('click', () => {
            fetch('{{ route("admin.notification.markAllRead") }}', {
                method: 'POST',
                headers: {
...
<script>
    ...
    editProfileBtn.addEventListener('click', (e) => {
        ...
        editProfileModal.classList.remove('hidden'); // Show the edit profile modal
    });
...
<!-- Add this at the end of the body section before closing </body> tag -->
</body>
</html>