                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    @if($data->status == 'ditolak')
                        <div class="mt-6 flex justify-center">
                            <a href="{{ route('pantau.show', ['no_pengajuan' => $data->no_pengajuan, 'resubmit' => true]) }}" 
                            class="bg-[#004aad] text-white px-6 py-3 rounded-md hover:bg-[#003b8a] transition font-semibold flex items-center">
